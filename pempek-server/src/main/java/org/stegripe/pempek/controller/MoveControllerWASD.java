package org.stegripe.pempek.controller;
...
import org.stegripe.pempek.event.entity.RidableSpacebarEvent;
...
public class MoveControllerWASD<T extends Mob> extends MoveControl<T> {
    ...
    public void pempekTick(Player rider) {
