...
public class PempekVersionFetcher implements VersionFetcher {
    private static final Logger LOGGER = LogUtils.getClassLogger();
    private static final int DISTANCE_ERROR = -1;
    private static final int DISTANCE_UNKNOWN = -2;
    private static final String DOWNLOAD_PAGE = "https://pempek.stegripe.org/downloads";
    private static final String REPOSITORY = "Stegripe/Pempek";
    ...
    static {
        ...
        USER_AGENT = BUILD_INFO.brandName() + "/" + BUILD_INFO.asString(VERSION_SIMPLE) + " (https://pempek.stegripe.org)";
    }
    ...
    private static int fetchDistanceFromSiteApi(final int jenkinsBuild) {
        try {
            try (final BufferedReader reader = Resources.asCharSource(
                URI.create("https://api.pempek.stegripe.org/v2/pempek/" + BUILD_INFO.minecraftVersionId()).toURL(),
                ...
                LOGGER.error("Error parsing json from Pempek's downloads API", ex);
