...
import org.stegripe.pempek.task.RamBarTask;
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("ram")
                ...
                .executes(context -> {
                    ...
                    sender.sendSuccess(() -> PaperAdventure.asVanilla(MiniMessage.miniMessage().deserialize(PempekConfig.ramCommandOutput,
