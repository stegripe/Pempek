package org.stegripe.pempek.entity.projectile;
        ...
        if (world instanceof ServerLevel worldserver) {
            ...
            if (shooter instanceof LivingEntity) {
                ...
                if (canGrief || (target instanceof LivingEntity && !(target instanceof ArmorStand))) {
                    boolean hurt = target.hurtServer(worldserver, target.damageSources().mobProjectile(this, (LivingEntity) shooter), worldserver.pempekConfig.phantomFlameDamage);
                    if (hurt && worldserver.pempekConfig.phantomFlameFireTime > 0) {
                        target.igniteForSeconds(worldserver.pempekConfig.phantomFlameFireTime);
                    }
                }
            }
        }
