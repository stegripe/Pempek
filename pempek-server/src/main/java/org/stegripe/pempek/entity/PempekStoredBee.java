package org.stegripe.pempek.entity;
...
public class PempekStoredBee implements StoredEntity<Bee> {
    ...
    private final CraftPersistentDataContainer persistentDataContainer = new CraftPersistentDataContainer(PempekStoredBee.DATA_TYPE_REGISTRY);

    private Component customName;

    public PempekStoredBee(BeehiveBlockEntity.BeeData data, EntityBlockStorage<Bee> blockStorage, final BeehiveBlockEntity blockEntity) {
        this.handle = data;
